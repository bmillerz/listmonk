...
// GetDashboardInsights returns live dashboard extras (30-day growth + monthly bounce rate).
func (a *App) GetDashboardInsights(c echo.Context) error {
	out, err := a.core.GetDashboardInsights()
	if err != nil {
		return err
	}
